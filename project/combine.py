...
def addContent4(document,type,startYear,MODELPATH):
    ...
    dc = df.to_dict("split")
    titles = [["单位名称","期末数","nan","nan","nan","nan","nan"],["nan","流动资产","非流动资产","资产合计","流动负债","非流动负债","负债合计"]]
    ...
    dc = df.to_dict("split")
    titles = [["单位名称","期初数","nan","nan","nan","nan","nan"],["nan","流动资产","非流动资产","资产合计","流动负债","非流动负债","负债合计"]]
    titleLength = len(titles)
    rowLength = len(dc["index"]) + titleLength
    columnLength = len(dc["columns"])
    table = createBorderedTable(document,rowLength,columnLength)
...
# （五）子公司与母公司会计期间不一致的说明
def addContent5(document,type,startYear,MODELPATH):
...
# （六）本年不再纳入合并范围的原子公司
def addContent6(document,type,startYear,MODELPATH):
    ...
    addContentToCombineTitle(document, dc, table, titleLength, style=3)
# （七）本年新纳入合并范围的主体
def addContent7(document,type,startYear,MODELPATH):
    addTitle(document, "（七）本年新纳入合并范围的主体", 2, True)
    df = pd.read_excel(MODELPATH, sheet_name="本年新纳入合并范围的主体")
    dc = df.to_dict("split")
    addTable(document, dc, style=6)
# （八）本年发生的同一控制下企业合并情况
def addContent8(document,type,startYear,MODELPATH):
...
def addContent13(document,type,startYear,MODELPATH):
...
def addContent14(document,type,startYear,MODELPATH):
...
def addContent15(document,type,startYear,MODELPATH):
...
def addContent(document,type,startYear,MODELPATH):
    addContent1(document,type,startYear,MODELPATH)
    addContent2(document,type,startYear,MODELPATH)
    addContent3(document,type,startYear,MODELPATH)
    addContent4(document,type,startYear,MODELPATH)
    addContent5(document,type,startYear,MODELPATH)
    addContent6(document,type,startYear,MODELPATH)
    addContent7(document,type,startYear,MODELPATH)
    addContent8(document,type,startYear,MODELPATH)
    addContent9(document,type,startYear,MODELPATH)
    addContent10(document,type,startYear,MODELPATH)
    addContent11(document,type,startYear,MODELPATH)
    addContent12(document,type,startYear,MODELPATH)
    addContent13(document,type,startYear,MODELPATH)
    addContent14(document,type,startYear,MODELPATH)
    addContent15(document,type,startYear,MODELPATH)
...
def entry():
    ...
    document = Document()
    setStyle(document)
    addLandscapeContent(document, addContent, type, startYear, MODELPATH)
