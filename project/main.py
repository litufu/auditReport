...
from project.constants import comparativeTable,tables,contrastSubjects,CURRENTPATH,PARENTPATH,balanceTitlesState,balanceTitlesList,profitTitlesState,profitTitlesList
...
if __name__ == '__main__':
    ...
    # 添加会计政策变更
    addChange(document, num, context, CURRENTPATH)
    # 添加税收政策
